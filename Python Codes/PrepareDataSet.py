...
# NOTES FOR SIDDHU, RUTUJA AND MAITREYI:
# THE CODE TAKES ROUGHLY 40-60 MINS TO RUN. DONT STOP EXECUTION IN BETWEEN THINKING ITS NOT RUNNING. ITS A 100% WORKING PIECE OF CODE.
# MAKE CHANGES ONLY TO PATH. NOTHING ELSE

with open('/Users/krunaaltavkar/PycharmProjects/SiddhantAmidwar/BE IT Project/src/data/stockmarketdata.csv', 'rb') as csvfile:
...
df1 = df
idx = pd.date_range('12-31-2007', '12-31-2018')
...
# YOU CAN COMMENT KEY ERROR AND TYPE ERROR IF YOU WANT. THAT IS JUST USED AS AN INDICATOR TO SHOW CODE IS RUNNING AND NOT STUCK IN AN INFINITE LOOP.
...
interpolated_df.to_pickle('/Users/krunaaltavkar/PycharmProjects/SiddhantAmidwar/BE IT Project/pickled_ten_year_filtered_lead_para.pkl')  

# Save pandas frame in csv form
interpolated_df.to_csv('/Users/krunaaltavkar/PycharmProjects/SiddhantAmidwar/BE IT Project/sample_interpolated_df_10_years_filtered_lead_para.csv',
                       sep='\t', encoding='utf-8')

# Reading the data as pickle file
dataframe_read = pd.read_pickle('/Users/krunaaltavkar/PycharmProjects/SiddhantAmidwar/BE IT Project/pickled_ten_year_filtered_lead_para.pkl')
